...
figure 저장 위치: `../result_fig/<작업단위>/` (run_stats → `01_망설계`, run_plot_cors·run_plot_integrated
→ `04_외부상설감시국`; 분류 기준은 `../result_fig/README.md`).
...
| `run_plot_qc_status.m` | QC 기준국 선별 상태 지도 (cut-off 전환·외곽 예외·평균 품질 미만 기준국, 코드 라벨) → `01_망설계/qc_station_status.png` |
