...
% (선택) 외부 JPNT 함수 폴더가 있으면 추가 (없으면 자동으로 건너뜀)
...
aa = geoplot(rtsStations.LAT_deg, rtsStations.LON_deg, 'gs', 'color', 'k', 'MarkerFaceColor','y', 'LineWidth', 1, 'MarkerSize', 6, 'HandleVisibility', 'off');

legend(aa,'국토지리정보원 위성기준점')
